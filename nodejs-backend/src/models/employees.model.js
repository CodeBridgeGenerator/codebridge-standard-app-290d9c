...
position: { type: Schema.Types.ObjectId, ref: "positions", comment: "Position, dropdown, false, true, true, true, true, true, true, positions, positions, one-to-one, name," },
supervisor: { type: Schema.Types.ObjectId, ref: "employees", comment: "Supervisor, dropdown, false, true, true, true, true, true, true, employees, employees, one-to-one, name," },
dateJoined: { type: Date, comment: "Date Joined, p_calendar, false, true, true, true, true, true, true, , , , ," },
dateTerminated: { type: Date, comment: "Date Terminated, p_calendar, false, true, true, true, true, true, true, , , , ," },
