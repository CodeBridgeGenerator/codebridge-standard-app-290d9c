...
const rolesCreated = await app.service("roles").Model.create({"emailToInvite":"new value","status":true,"position":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"name":"new value","description":"new value","isDefault":true,"abbr":"new value","role":"parentObjectId"});
const companiesCreated = await app.service("companies").Model.create({"emailToInvite":"new value","status":true,"position":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"name":"new value","description":"new value","isDefault":true,"abbr":"new value","role":`${rolesCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.393Z","isdefault":true});
const companiesCreated = await app.service("companies").Model.create({"emailToInvite":"new value","status":true,"position":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"name":"new value","description":"new value","isDefault":true,"abbr":"new value","role":`${rolesCreated._id}`,"company":`${companiesCreated._id}`,"companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.393Z","isdefault":true,"branch":"parentObjectId","companyId":"parentObjectId"});
const branchesCreated = await app.service("branches").Model.create({"emailToInvite":"new value","status":true,"position":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"name":"new value","description":"new value","isDefault":true,"abbr":"new value","role":`${rolesCreated._id}`,"company":`${companiesCreated._id}`,"companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.393Z","isdefault":true,"branch":"parentObjectId","companyId":`${companiesCreated._id}`});
const departmentsCreated = await app.service("departments").Model.create({"emailToInvite":"new value","status":true,"position":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"name":"new value","description":"new value","isDefault":true,"abbr":"new value","role":`${rolesCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.393Z","isdefault":true,"branch":`${branchesCreated._id}`,"companyId":`${companiesCreated._id}`,"department":"parentObjectId","deptName":"new value","code":"new value"});
const departmentsCreated = await app.service("departments").Model.create({"emailToInvite":"new value","status":true,"position":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"name":"new value","description":"new value","isDefault":true,"abbr":"new value","role":`${rolesCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.393Z","isdefault":true,"branch":`${branchesCreated._id}`,"companyId":`${companiesCreated._id}`,"department":`${departmentsCreated._id}`,"deptName":"new value","code":"new value","section":"parentObjectId","departmentId":"parentObjectId"});
const sectionsCreated = await app.service("sections").Model.create({"emailToInvite":"new value","status":true,"position":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"name":"new value","description":"new value","isDefault":true,"abbr":"new value","role":`${rolesCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.393Z","isdefault":true,"branch":`${branchesCreated._id}`,"companyId":`${companiesCreated._id}`,"department":`${departmentsCreated._id}`,"deptName":"new value","code":"new value","section":"parentObjectId","departmentId":`${departmentsCreated._id}`});
  ...
  describe("#create", () => {
    const options = {"emailToInvite":"new value","status":true,"position":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"name":"new value","description":"new value","isDefault":true,"abbr":"new value","role":`${rolesCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.393Z","isdefault":true,"branch":`${branchesCreated._id}`,"companyId":`${companiesCreated._id}`,"department":`${departmentsCreated._id}`,"deptName":"new value","code":23,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"sendMailCounter":23};
