...
describe("branches service", async () => {
  ...
  const companiesCreated = await app.service("companies").Model.create({"companyId":"parentObjectId","name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:39.877Z","isdefault":true});
  ...
  describe("#create", () => {
    const options = {"companyId":`${companiesCreated._id}`,"name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:39.877Z","isdefault":true,"isDefault":true};
