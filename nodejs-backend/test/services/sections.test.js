...
describe("sections service", async () => {
  ...
  const companiesCreated = await app.service("companies").Model.create({"departmentId":"parentObjectId","company":"parentObjectId","name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.184Z","isdefault":true});
const departmentsCreated = await app.service("departments").Model.create({"departmentId":"parentObjectId","company":`${companiesCreated._id}`,"name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.184Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true});
  ...
  describe("#create", () => {
    const options = {"departmentId":`${departmentsCreated._id}`,"company":`${companiesCreated._id}`,"name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.184Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true};
