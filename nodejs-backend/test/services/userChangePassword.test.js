...
describe("userChangePassword service", async () => {
  ...
  describe("#create", () => {
    const options = {"userEmail":"new value","server":"new value","environment":"new value","code":"new value","status":true,"sendEmailCounter":23,"lastAttempt":"2026-03-03T23:10:43.305Z","ipAddress":"new value"};
...
assert.strictEqual(userChangePasswordCreated.lastAttempt.toISOString(), options.lastAttempt);
assert.strictEqual(userChangePasswordCreated.ipAddress, options.ipAddress);
  ...
  describe("#update", () => {
    const options = {"userEmail":"updated value","server":"updated value","environment":"updated value","code":"updated value","status":false,"sendEmailCounter":100,"lastAttempt":"2026-03-03T23:10:43.305Z","ipAddress":"updated value"};
...
assert.strictEqual(userChangePasswordUpdated.lastAttempt.toISOString(), options.lastAttempt);
