...
const rolesCreated = await app.service("roles").Model.create({"user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":"parentObjectId","roleId":"parentObjectId"});
const positionsCreated = await app.service("positions").Model.create({"user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":"parentObjectId","roleId":`${rolesCreated._id}`,"abbr":"new value"});
const usersCreated = await app.service("users").Model.create({"user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","profiles":"parentObjectId","userId":"parentObjectId"});
const companiesCreated = await app.service("companies").Model.create({"user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":"parentObjectId","company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.032Z","isdefault":true});
const departmentsCreated = await app.service("departments").Model.create({"user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":"parentObjectId","company":`${companiesCreated._id}`,"companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.032Z","isdefault":true,"deptName":"new value","code":"new value"});
const departmentsCreated = await app.service("departments").Model.create({"user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.032Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":"parentObjectId","departmentId":"parentObjectId"});
const sectionsCreated = await app.service("sections").Model.create({"user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.032Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":"parentObjectId","departmentId":`${departmentsCreated._id}`});
const rolesCreated = await app.service("roles").Model.create({"user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.032Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":"parentObjectId"});
const positionsCreated = await app.service("positions").Model.create({"user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":"parentObjectId","abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.032Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"position":"parentObjectId"});
const usersCreated = await app.service("users").Model.create({"user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":"parentObjectId","abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.032Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"position":`${positionsCreated._id}`,"manager":"parentObjectId"});
const companiesCreated = await app.service("companies").Model.create({"user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":"parentObjectId","abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.035Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"position":`${positionsCreated._id}`,"manager":`${usersCreated._id}`,"branch":"parentObjectId","companyId":"parentObjectId"});
