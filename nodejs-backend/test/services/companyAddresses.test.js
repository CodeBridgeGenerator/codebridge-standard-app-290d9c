...
describe("companyAddresses service", async () => {
  ...
  const companiesCreated = await app.service("companies").Model.create({"company":"parentObjectId","name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.927Z","isdefault":true});
  ...
  describe("#create", () => {
    const options = {"company":`${companiesCreated._id}`,"name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.927Z","isdefault":true,"street1":"new value","street2":"new value","poscode":"new value","city":"new value","state":"new value","province":"new value","country":"new value","isDefault":true};
