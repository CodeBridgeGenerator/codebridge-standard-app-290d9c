...
describe("loginHistories service", async () => {
  ...
  describe("#create", () => {
    const options = {"userId":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"device":"new value","browser":"new value","userAgent":"new value","loginTime":"2026-03-03T23:10:42.860Z"};
...
assert.strictEqual(loginHistoryCreated.loginTime.toISOString(), options.loginTime);
    });
  });
  ...
  describe("#update", () => {
    const options = {"userId":`${usersCreated._id}`,"device":"updated value","browser":"updated value","userAgent":"updated value","loginTime":"2026-03-03T23:10:42.860Z"};
...
assert.strictEqual(loginHistoryUpdated.loginTime.toISOString(), options.loginTime);
    });
  });
