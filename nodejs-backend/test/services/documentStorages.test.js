...
describe("documentStorages service", async () => {
  ...
  describe("#create", () => {
    const options = {"name":"new value","size":23,"path":"new value","lastModifiedDate":"2026-03-03T23:10:42.232Z","lastModified":23,"eTag":"new value","versionId":"new value","url":"new value","tableId":"new value","tableName":"new value"};
...
assert.strictEqual(documentStorageCreated.lastModifiedDate.toISOString(), options.lastModifiedDate);
...
assert.strictEqual(documentStorageCreated.tableName, options.tableName);
  ...
  describe("#update", () => {
    const options = {"name":"updated value","size":100,"path":"updated value","lastModifiedDate":"2026-03-03T23:10:42.232Z","lastModified":100,"eTag":"updated value","versionId":"updated value","url":"updated value","tableId":"updated value","tableName":"updated value"};
...
assert.strictEqual(documentStorageUpdated.lastModifiedDate.toISOString(), options.lastModifiedDate);
