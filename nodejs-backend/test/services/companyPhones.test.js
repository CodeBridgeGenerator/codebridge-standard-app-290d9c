...
describe("companyPhones service", async () => {
  ...
  const companiesCreated = await app.service("companies").Model.create({"companyId":"parentObjectId","name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:41.025Z","isdefault":true});
  ...
  describe("#create", () => {
    const options = {"companyId":`${companiesCreated._id}`,"name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:41.025Z","isdefault":true,"countryCode":23,"operatorCode":23,"number":23,"type":["new value"],"isDefault":true};
