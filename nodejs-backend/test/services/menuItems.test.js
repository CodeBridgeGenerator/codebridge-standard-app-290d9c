...
const rolesCreated = await app.service("roles").Model.create({"userContext":"parentObjectId","user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":"parentObjectId","roleId":"parentObjectId"});
const positionsCreated = await app.service("positions").Model.create({"userContext":"parentObjectId","user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":"parentObjectId","roleId":`${rolesCreated._id}`,"abbr":"new value"});
const usersCreated = await app.service("users").Model.create({"userContext":"parentObjectId","user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","profiles":"parentObjectId","userId":"parentObjectId"});
const companiesCreated = await app.service("companies").Model.create({"userContext":"parentObjectId","user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":"parentObjectId","company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.133Z","isdefault":true});
const departmentsCreated = await app.service("departments").Model.create({"userContext":"parentObjectId","user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":"parentObjectId","company":`${companiesCreated._id}`,"companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.133Z","isdefault":true,"deptName":"new value","code":"new value"});
const departmentsCreated = await app.service("departments").Model.create({"userContext":"parentObjectId","user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.133Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":"parentObjectId","departmentId":"parentObjectId"});
const sectionsCreated = await app.service("sections").Model.create({"userContext":"parentObjectId","user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.133Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":"parentObjectId","departmentId":`${departmentsCreated._id}`});
const rolesCreated = await app.service("roles").Model.create({"userContext":"parentObjectId","user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.133Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":"parentObjectId"});
const positionsCreated = await app.service("positions").Model.create({"userContext":"parentObjectId","user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":"parentObjectId","abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.133Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"position":"parentObjectId"});
const usersCreated = await app.service("users").Model.create({"userContext":"parentObjectId","user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":"parentObjectId","abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.133Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"position":`${positionsCreated._id}`,"manager":"parentObjectId"});
const companiesCreated = await app.service("companies").Model.create({"userContext":"parentObjectId","user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":"parentObjectId","abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.135Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"position":`${positionsCreated._id}`,"manager":`${usersCreated._id}`,"branch":"parentObjectId","companyId":"parentObjectId"});
const branchesCreated = await app.service("branches").Model.create({"userContext":"parentObjectId","user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":"parentObjectId","abbr":"new value","profiles":"parentObjectId","userId":`${usersCreated._id}`,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.135Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"position":`${positionsCreated._id}`,"manager":`${usersCreated._id}`,"branch":"parentObjectId","companyId":`${companiesCreated._id}`});
const userAddressesCreated = await app.service("userAddresses").Model.create({"userContext":"parentObjectId","user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":"parentObjectId","abbr":"new value","profiles":"parentObjectId","userId":"parentObjectId","image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.135Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"position":`${positionsCreated._id}`,"manager":`${usersCreated._id}`,"branch":`${branchesCreated._id}`,"companyId":`${companiesCreated._id}`,"skills":"new value","address":"parentObjectId","street1":"new value","street2":"new value","postalCode":"new value","city":"new value","state":"new value","province":"new value","country":"new value"});
const userPhonesCreated = await app.service("userPhones").Model.create({"userContext":"parentObjectId","user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":"parentObjectId","abbr":"new value","profiles":"parentObjectId","userId":"parentObjectId","image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.135Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"position":`${positionsCreated._id}`,"manager":`${usersCreated._id}`,"branch":`${branchesCreated._id}`,"companyId":`${companiesCreated._id}`,"skills":"new value","address":`${userAddressesCreated._id}`,"street1":"new value","street2":"new value","postalCode":"new value","city":"new value","state":"new value","province":"new value","country":"new value","phone":"parentObjectId","countryCode":23,"operatorCode":23,"number":23,"type":["new value"]});
...
const profileMenuCreated = await app.service("profileMenu").Model.create({"userContext":"parentObjectId","user":`${usersCreated._id}`,"name":"new value","email":"new value","password":"new value","status":true,"roles":`${rolesCreated._id}`,"description":"new value","isDefault":true,"positions":`${positionsCreated._id}`,"roleId":"parentObjectId","abbr":"new value","profiles":`${profilesCreated._id}`,"userId":"parentObjectId","image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.135Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":"parentObjectId","departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"position":`${positionsCreated._id}`,"manager":`${usersCreated._id}`,"branch":"parentObjectId","companyId":`${companiesCreated._id}`,"skills":"new value","address":`${userAddressesCreated._id}`,"street1":"new value","street2":"new value","postalCode":"new value","city":"new value","state":"new value","province":"new value","country":"new value","phone":`${userPhonesCreated._id}`,"countryCode":23,"operatorCode":23,"number":23,"type":["new value"],"menuItems":{"name":"John Doe Many","age":20,"dateofbirth":"1999-01-01T00:00:00.000Z"}});
