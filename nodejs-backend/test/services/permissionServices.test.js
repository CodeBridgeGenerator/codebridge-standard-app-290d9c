...
const companiesCreated = await app.service("companies").Model.create({"service":"new value","create":true,"read":true,"update":true,"delete":true,"import":true,"export":true,"seeder":true,"userId":"parentObjectId","name":"new value","email":"new value","password":"new value","status":true,"roleId":`${rolesCreated._id}`,"description":"new value","isDefault":true,"profile":"parentObjectId","image":"new value","bio":"new value","department":"parentObjectId","company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.758Z","isdefault":true});
const departmentsCreated = await app.service("departments").Model.create({"service":"new value","create":true,"read":true,"update":true,"delete":true,"import":true,"export":true,"seeder":true,"userId":"parentObjectId","name":"new value","email":"new value","password":"new value","status":true,"roleId":`${rolesCreated._id}`,"description":"new value","isDefault":true,"profile":"parentObjectId","image":"new value","bio":"new value","department":"parentObjectId","company":`${companiesCreated._id}`,"companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.758Z","isdefault":true,"deptName":"new value","code":"new value"});
const departmentsCreated = await app.service("departments").Model.create({"service":"new value","create":true,"read":true,"update":true,"delete":true,"import":true,"export":true,"seeder":true,"userId":"parentObjectId","name":"new value","email":"new value","password":"new value","status":true,"roleId":`${rolesCreated._id}`,"description":"new value","isDefault":true,"profile":"parentObjectId","image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.758Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":"parentObjectId","departmentId":"parentObjectId"});
const sectionsCreated = await app.service("sections").Model.create({"service":"new value","create":true,"read":true,"update":true,"delete":true,"import":true,"export":true,"seeder":true,"userId":"parentObjectId","name":"new value","email":"new value","password":"new value","status":true,"roleId":`${rolesCreated._id}`,"description":"new value","isDefault":true,"profile":"parentObjectId","image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.758Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":"parentObjectId","departmentId":`${departmentsCreated._id}`});
const rolesCreated = await app.service("roles").Model.create({"service":"new value","create":true,"read":true,"update":true,"delete":true,"import":true,"export":true,"seeder":true,"userId":"parentObjectId","name":"new value","email":"new value","password":"new value","status":true,"roleId":`${rolesCreated._id}`,"description":"new value","isDefault":true,"profile":"parentObjectId","image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.758Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":"parentObjectId"});
...
const usersCreated = await app.service("users").Model.create({"service":"new value","create":true,"read":true,"update":true,"delete":true,"import":true,"export":true,"seeder":true,"userId":"parentObjectId","name":"new value","email":"new value","password":"new value","status":true,"roleId":"parentObjectId","description":"new value","isDefault":true,"profile":"parentObjectId","image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.758Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"position":`${positionsCreated._id}`,"abbr":"new value","manager":"parentObjectId"});
const companiesCreated = await app.service("companies").Model.create({"service":"new value","create":true,"read":true,"update":true,"delete":true,"import":true,"export":true,"seeder":true,"userId":"parentObjectId","name":"new value","email":"new value","password":"new value","status":true,"roleId":"parentObjectId","description":"new value","isDefault":true,"profile":"parentObjectId","image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.762Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"position":`${positionsCreated._id}`,"abbr":"new value","manager":`${usersCreated._id}`,"branch":"parentObjectId","companyId":"parentObjectId"});
...
const positionsCreated = await app.service("positions").Model.create({"service":"new value","create":true,"read":true,"update":true,"delete":true,"import":true,"export":true,"seeder":true,"userId":"parentObjectId","name":"new value","email":"new value","password":"new value","status":true,"roleId":"parentObjectId","description":"new value","isDefault":true,"profile":`${profilesCreated._id}`,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:43.762Z","isdefault":true,"deptName":"new value","code":"new value","hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"position":`${positionsCreated._id}`,"abbr":"new value","manager":`${usersCreated._id}`,"branch":`${branchesCreated._id}`,"companyId":`${companiesCreated._id}`,"skills":"new value","address":`${userAddressesCreated._id}`,"street1":"new value","street2":"new value","postalCode":"new value","city":"new value","state":"new value","province":"new value","country":"new value","phone":`${userPhonesCreated._id}`,"countryCode":23,"operatorCode":23,"number":23,"type":["new value"],"positionId":"parentObjectId"});
