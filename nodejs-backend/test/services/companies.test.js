...
describe("companies service", async () => {
  ...
  describe("#create", () => {
    const options = {"name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:39.735Z","isdefault":true};
...
assert.strictEqual(companyCreated.isdefault, options.isdefault);
  ...
  describe("#update", () => {
    const options = {"name":"updated value","companyNo":"updated value","newCompanyNumber":"updated value","DateIncorporated":"2026-03-03T23:10:39.735Z","isdefault":false};
