...
describe("userGuide service", async () => {
  ...
  describe("#create", () => {
    const options = {"serviceName":"new value","expiry":"2026-03-03T23:10:41.792Z"};
...
assert.strictEqual(userGuideCreated.expiry.toISOString(), options.expiry);
    });
  });
  ...
  describe("#update", () => {
    const options = {"serviceName":"updated value","expiry":"2026-03-03T23:10:41.792Z"};
...
assert.strictEqual(userGuideUpdated.expiry.toISOString(), options.expiry);
    });
  });
