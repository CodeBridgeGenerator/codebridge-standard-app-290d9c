...
describe("departments service", async () => {
  ...
  const companiesCreated = await app.service("companies").Model.create({"company":"parentObjectId","name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:39.984Z","isdefault":true});
  ...
  describe("#create", () => {
    const options = {"company":`${companiesCreated._id}`,"name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:39.984Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true};
