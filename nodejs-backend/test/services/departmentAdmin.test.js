...
describe("departmentAdmin service", async () => {
  ...
  const companiesCreated = await app.service("companies").Model.create({"departmentId":"parentObjectId","company":"parentObjectId","name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:41.480Z","isdefault":true});
const departmentsCreated = await app.service("departments").Model.create({"departmentId":"parentObjectId","company":`${companiesCreated._id}`,"name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:41.480Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true});
const employeesCreated = await app.service("employees").Model.create({"departmentId":`${departmentsCreated._id}`,"company":"new value","name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:41.480Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true,"employeeId":"parentObjectId","empNo":"new value","fullName":"new value","department":"new value","section":"new value","position":"new value","supervisor":"new value","dateJoined":"new value","dateTerminated":"new value","resigned":"new value","empGroup":"new value","empCode":"new value"});
  ...
  describe("#create", () => {
    const options = {"departmentId":`${departmentsCreated._id}`,"company":"new value","name":"new value","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:41.480Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true,"employeeId":`${employeesCreated._id}`,"empNo":"new value","fullName":"new value","department":"new value","section":"new value","position":"new value","supervisor":"new value","dateJoined":"new value","dateTerminated":"new value","resigned":"new value","empGroup":"new value","empCode":"new value"};
