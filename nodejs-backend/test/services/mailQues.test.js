...
describe("mailQues service", async () => {
  ...
  describe("#create", () => {
    const options = {"name":"new value","from":"new value","subject":"new value","recipients":["new value"],"content":"new value","payload":{"name":"John Doe Many","age":20,"dateofbirth":"1999-01-01T00:00:00.000Z"},"templateId":"new value","status":true,"jobId":23,"end":"2026-03-03T23:10:42.941Z"};
...
assert.strictEqual(mailQueCreated.end.toISOString(), options.end);
    });
  });
  ...
  describe("#update", () => {
    const options = {"name":"updated value","from":"updated value","subject":"updated value","recipients":["updated value"],"content":"updated value","payload":{"name":"John Doe","age":200,"dateofbirth":"2025-01-31T00:00:00.000Z"},"templateId":"updated value","status":false,"jobId":100,"end":"2026-03-03T23:10:42.941Z"};
...
assert.strictEqual(mailQueUpdated.end.toISOString(), options.end);
    });
  });
