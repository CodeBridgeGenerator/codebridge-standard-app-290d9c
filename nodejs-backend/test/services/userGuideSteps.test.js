...
describe("userGuideSteps service", async () => {
  ...
  const userGuideCreated = await app.service("userGuide").Model.create({"userGuideID":"parentObjectId","serviceName":"new value","expiry":"2026-03-03T23:10:41.709Z"});
  ...
  describe("#create", () => {
    const options = {"userGuideID":`${userGuideCreated._id}`,"serviceName":"new value","expiry":"2026-03-03T23:10:41.709Z","Steps":"new value","Description":"new value"};
