...
const companiesCreated = await app.service("companies").Model.create({"name":"new value","userId":`${usersCreated._id}`,"email":"new value","password":"new value","status":true,"image":"new value","bio":"new value","department":"parentObjectId","company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.631Z","isdefault":true});
const departmentsCreated = await app.service("departments").Model.create({"name":"new value","userId":`${usersCreated._id}`,"email":"new value","password":"new value","status":true,"image":"new value","bio":"new value","department":"parentObjectId","company":`${companiesCreated._id}`,"companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.631Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true});
const departmentsCreated = await app.service("departments").Model.create({"name":"new value","userId":`${usersCreated._id}`,"email":"new value","password":"new value","status":true,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.631Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true,"hod":true,"section":"parentObjectId","departmentId":"parentObjectId"});
const sectionsCreated = await app.service("sections").Model.create({"name":"new value","userId":`${usersCreated._id}`,"email":"new value","password":"new value","status":true,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.631Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true,"hod":true,"section":"parentObjectId","departmentId":`${departmentsCreated._id}`});
const rolesCreated = await app.service("roles").Model.create({"name":"new value","userId":`${usersCreated._id}`,"email":"new value","password":"new value","status":true,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.631Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true,"hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":"parentObjectId","description":"new value"});
const rolesCreated = await app.service("roles").Model.create({"name":"new value","userId":`${usersCreated._id}`,"email":"new value","password":"new value","status":true,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.631Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true,"hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"description":"new value","position":"parentObjectId","roleId":"parentObjectId"});
const positionsCreated = await app.service("positions").Model.create({"name":"new value","userId":`${usersCreated._id}`,"email":"new value","password":"new value","status":true,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.631Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true,"hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"description":"new value","position":"parentObjectId","roleId":`${rolesCreated._id}`,"abbr":"new value"});
const usersCreated = await app.service("users").Model.create({"name":"new value","userId":`${usersCreated._id}`,"email":"new value","password":"new value","status":true,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.631Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true,"hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"description":"new value","position":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","manager":"parentObjectId"});
const companiesCreated = await app.service("companies").Model.create({"name":"new value","userId":`${usersCreated._id}`,"email":"new value","password":"new value","status":true,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.634Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true,"hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"description":"new value","position":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","manager":`${usersCreated._id}`,"branch":"parentObjectId","companyId":"parentObjectId"});
const branchesCreated = await app.service("branches").Model.create({"name":"new value","userId":`${usersCreated._id}`,"email":"new value","password":"new value","status":true,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.634Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true,"hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"description":"new value","position":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","manager":`${usersCreated._id}`,"branch":"parentObjectId","companyId":`${companiesCreated._id}`});
const userAddressesCreated = await app.service("userAddresses").Model.create({"name":"new value","userId":"parentObjectId","email":"new value","password":"new value","status":true,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.634Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true,"hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"description":"new value","position":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","manager":`${usersCreated._id}`,"branch":`${branchesCreated._id}`,"companyId":`${companiesCreated._id}`,"skills":"new value","address":"parentObjectId","street1":"new value","street2":"new value","postalCode":"new value","city":"new value","state":"new value","province":"new value","country":"new value"});
const userPhonesCreated = await app.service("userPhones").Model.create({"name":"new value","userId":"parentObjectId","email":"new value","password":"new value","status":true,"image":"new value","bio":"new value","department":`${departmentsCreated._id}`,"company":"parentObjectId","companyNo":"new value","newCompanyNumber":"new value","DateIncorporated":"2026-03-03T23:10:40.634Z","isdefault":true,"deptName":"new value","code":"new value","isDefault":true,"hod":true,"section":`${sectionsCreated._id}`,"departmentId":`${departmentsCreated._id}`,"hos":true,"role":`${rolesCreated._id}`,"description":"new value","position":`${positionsCreated._id}`,"roleId":`${rolesCreated._id}`,"abbr":"new value","manager":`${usersCreated._id}`,"branch":`${branchesCreated._id}`,"companyId":`${companiesCreated._id}`,"skills":"new value","address":`${userAddressesCreated._id}`,"street1":"new value","street2":"new value","postalCode":"new value","city":"new value","state":"new value","province":"new value","country":"new value","phone":"parentObjectId","countryCode":23,"operatorCode":23,"number":23,"type":["new value"]});
