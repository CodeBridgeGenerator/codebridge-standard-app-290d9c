...
import seederData from "./userGuideSteps.seeder.json";
...
const UserGuideStepsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(UserGuideStepsSeederDialogComponent);
