...
const ChataiPromptsEditDialogComponent = (props) => {
...
chatAiConfig: _entity?.chatAiConfig?._id,
...
error: _entity?.error,
userRemarks: _entity?.userRemarks,
thumbsDown: _entity?.thumbsDown,
thumbsUp: _entity?.thumbsUp,
copies: _entity?.copies,
emailed: _entity?.emailed,
        };

        setLoading(true);
        try {
            
        await client.service("chataiPrompts").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info chataiPrompts updated successfully" });
...
const chatAiConfigOptions = chatAiConfig.map((elem) => ({ name: elem.name, value: elem.value }));
    ...
    return (
        <Dialog header="Edit Chat Ai Prompts" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="chataiPrompts-edit-dialog-component">
...
<div className="col-12 field">
                <span className="align-items-center">
                    ...
                    <UploadFilesToS3 type={'edit'} setValByKey={setValByKey} onSave={onSave} id={urlParams.singleChataiPromptsId} serviceName="chataiPrompts" />
                </span>
                <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="inputTokens" className="w-full mb-3 p-inputtext-sm" value={_entity?.inputTokens} onChange={(e) => setValByKey("inputTokens", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="outputTokens" className="w-full mb-3 p-inputtext-sm" value={_entity?.outputTokens} onChange={(e) => setValByKey("outputTokens", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="cost" className="w-full mb-3" mode="currency" currency="MYR" locale="en-US" value={_entity?.cost} onValueChange={(e) => setValByKey("cost", e.value)} useGrouping={false}  />
            </span>
            <small className="p-error">
...
export default connect(mapState, mapDispatch)(ChataiPromptsEditDialogComponent);
