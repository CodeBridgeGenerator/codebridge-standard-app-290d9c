...
import seederData from "./chataiPrompts.seeder.json";
...
const ChataiPromptsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ChataiPromptsSeederDialogComponent);
