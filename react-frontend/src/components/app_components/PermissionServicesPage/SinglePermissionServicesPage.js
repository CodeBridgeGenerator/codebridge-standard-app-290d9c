...
const [positionId, setPositionId] = useState([]);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singlePermissionServicesId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
                ...
                service: "users",
                select: ["name"],
              },"userId","roleId","profile","positionId"] }})
            .then((res) => {
                set_entity(res || {});
...
const positionId = Array.isArray(res.positionId)
    ...
    const goBack = () => {
        navigate("/app/permissionServices");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Permission Services</h3>
                    <SplitButton
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">create</label><p className="m-0" ><i id="create" className={`pi ${_entity?.create?"pi-check": "pi-times"}`}  ></i></p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">update</label><p className="m-0" ><i id="update" className={`pi ${_entity?.update?"pi-check": "pi-times"}`}  ></i></p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">delete</label><p className="m-0" ><i id="delete" className={`pi ${_entity?.delete?"pi-check": "pi-times"}`}  ></i></p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">import</label><p className="m-0" ><i id="import" className={`pi ${_entity?.import?"pi-check": "pi-times"}`}  ></i></p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">export</label><p className="m-0" ><i id="export" className={`pi ${_entity?.export?"pi-check": "pi-times"}`}  ></i></p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">seeder</label><p className="m-0" ><i id="seeder" className={`pi ${_entity?.seeder?"pi-check": "pi-times"}`}  ></i></p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Role Id</label>
                    {roleId.map((elem) => (
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Position Id</label>
                    {positionId.map((elem) => (
    ...
    <div className="col-12 mt-2">
        <TabView>
                    ...
                    <TabPanel header="Permission Fields" leftIcon="pi pi-building-columns mr-2">
      ...
      <CommentsSection
        recordId={urlParams.singlePermissionServicesId}
        user={props.user}
        alert={props.alert}
