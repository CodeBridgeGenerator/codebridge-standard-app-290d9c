...
const [sectionHeadIds, setsectionHeadIds] = useState();
...
client.service("employees")
    ...
    const onRun = async () => {
        let fakeData = departmentHOSFakerFactory(props.user,fakerCount,departmentIdIds,sectionHeadIds);
