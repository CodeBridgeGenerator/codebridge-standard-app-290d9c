...
import seederData from "./menuItems.seeder.json";
...
const MenuItemsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MenuItemsSeederDialogComponent);
