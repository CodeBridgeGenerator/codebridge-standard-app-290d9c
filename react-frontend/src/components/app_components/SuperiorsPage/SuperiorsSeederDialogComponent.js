...
import seederData from "./superiors.seeder.json";
...
const SuperiorsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SuperiorsSeederDialogComponent);
