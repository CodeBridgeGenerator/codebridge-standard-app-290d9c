...
import seederData from "./userTrackerId.seeder.json";
...
const UserTrackerIdSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(UserTrackerIdSeederDialogComponent);
