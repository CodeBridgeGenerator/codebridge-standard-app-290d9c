...
const BranchesDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
const p_booleanTemplate2 = (rowData, { rowIndex }) => <p >{String(rowData.isDefault)}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="companyId" header="Company" body={dropdownTemplate0} filter={selectedFilterFields.includes("companyId")} hidden={selectedHideFields?.includes("companyId")}  sortable style={{ minWidth: "8rem" }} />
