...
const BranchesEditDialogComponent = (props) => {
...
isDefault: _entity?.isDefault,
    ...
    return (
        <Dialog header="Edit Branches" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
...
export default connect(mapState, mapDispatch)(BranchesEditDialogComponent);
