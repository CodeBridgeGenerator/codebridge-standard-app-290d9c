...
import seederData from "./fcmMessages.seeder.json";
...
const FcmMessagesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(FcmMessagesSeederDialogComponent);
