...
const CompanyPhonesEditDialogComponent = (props) => {
...
isDefault: _entity?.isDefault,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info companyPhones updated successfully" });
    ...
    return (
        <Dialog header="Edit Company Phones" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="companyPhones-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(CompanyPhonesEditDialogComponent);
