...
const DepartmentsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("departments")
            .find({ query: { $limit: 10000 , companyIds : urlParams.singleCompaniesId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="departments-add-button"/>
            ...
            <div className="grid align-items-center">
                <div className="col-12" role="departments-datatable">
                    <DepartmentsDatatable items={data} fields={fields} onRowDelete={onRowDelete} onEditRow={onEditRow} onRowClick={onRowClick} searchDialog={searchDialog} setSearchDialog={setSearchDialog}
