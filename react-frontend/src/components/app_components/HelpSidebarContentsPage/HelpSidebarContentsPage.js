    ...
    useEffect(() => {
        ...
        client
            ...
            .catch((error) => {
                ...
                setLoading(false);
                props.hide();
                props.alert({ title: "Help Sidebar Contents", type: "error", message: error.message || "Failed get Help Sidebar Contents" });
            });
  ...
  const onClickSaveHiddenfields = (ff) => {
    ...
    const deleteRow = async () => {
        try {
            ...
            console.log({ error });
            props.alert({ title: "Help Sidebar Contents", type: "error", message: error.message || "Failed delete record" });
        }
    };
            ...
            <div className="grid">
                <div className="col-6 flex align-items-center justify-content-start">
                    <h4 className="mb-0 ml-2">
                        <span> My App /{" "}</span>
                        <strong>Help Sidebar Contents </strong>
                    </h4>
                    <SplitButton
