...
const ProfilesPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("profiles")
            .find({ query: { $limit: 10000 , userId : urlParams.singleUsersId ,department : urlParams.singleDepartmentsId ,section : urlParams.singleSectionsId ,role : urlParams.singleRolesId ,position : urlParams.singlePositionsId ,manager : urlParams.singleUsersId ,company : urlParams.singleCompaniesId ,branch : urlParams.singleBranchesId ,address : urlParams.singleUserAddressesId ,phone : urlParams.singleUserPhonesId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="profiles-add-button"/>
            ...
            <div className="grid align-items-center">
                <div className="col-12" role="profiles-datatable">
                    <ProfilesDatatable items={data} fields={fields} onRowDelete={onRowDelete} onEditRow={onEditRow} onRowClick={onRowClick} searchDialog={searchDialog} setSearchDialog={setSearchDialog}
