...
const AuditsEditDialogComponent = (props) => {
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputText id="action" className="w-full mb-3 p-inputtext-sm" value={_entity?.action} onChange={(e) => setValByKey("action", e.target.value)}  />
            </span>
            <small className="p-error">
...
export default connect(mapState, mapDispatch)(AuditsEditDialogComponent);
