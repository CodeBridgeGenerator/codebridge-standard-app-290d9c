...
import seederData from "./documentStorages.seeder.json";
...
const DocumentStoragesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DocumentStoragesSeederDialogComponent);
