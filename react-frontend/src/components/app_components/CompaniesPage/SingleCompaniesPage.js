...
import UserInvitesPage from "../UserInvitesPage/UserInvitesPage";
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">New company number</label><p className="m-0 ml-3" >{_entity?.newCompanyNumber}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Is default</label><p className="m-0" ><i id="isdefault" className={`pi ${_entity?.isdefault?"pi-check": "pi-times"}`}  ></i></p></div>
    ...
    <div className="col-12 mt-2">
        <TabView>
                    ...
                    <TabPanel header="Departments" leftIcon="pi pi-building-columns mr-2">
                        <DepartmentsPage/>
                    </TabPanel>
                    

                    <TabPanel header="Profiles" leftIcon="pi pi-building-columns mr-2">
                        <ProfilesPage/>
                    </TabPanel>
                    

                    <TabPanel header="Company Addresses" leftIcon="pi pi-building-columns mr-2">
                        <CompanyAddressesPage/>
                    </TabPanel>
                    

                    <TabPanel header="Company Phones" leftIcon="pi pi-building-columns mr-2">
                        <CompanyPhonesPage/>
                    </TabPanel>
                    ...
                    <TabPanel header="User Invites" leftIcon="pi pi-building-columns mr-2">
                        <UserInvitesPage/>
                    </TabPanel>
