...
const SectionsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("sections")
            .find({ query: { $limit: 10000 , departmentId : urlParams.singleDepartmentsId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="sections-add-button"/>
            ...
            <div className="grid align-items-center">
                <div className="col-12" role="sections-datatable">
                    <SectionsDatatable items={data} fields={fields} onRowDelete={onRowDelete} onEditRow={onEditRow} onRowClick={onRowClick} searchDialog={searchDialog} setSearchDialog={setSearchDialog}
