...
import seederData from "./chataiConfig.seeder.json";
...
const ChataiConfigSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ChataiConfigSeederDialogComponent);
