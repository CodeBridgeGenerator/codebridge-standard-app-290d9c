...
const PermissionFieldsPage = (props) => {
    ...
    const filename = "permissionFields";
    ...
    useEffect(() => {
        ...
        client
            ...
            .find({ query: { $limit: 10000 , servicePermissionId : urlParams.singlePermissionServicesId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
            ...
            .catch((error) => {
                ...
                setLoading(false);
                props.hide();
                props.alert({ title: "Permission Fields", type: "error", message: error.message || "Failed get Permission Fields" });
            });
  ...
  const onClickSaveHiddenfields = (ff) => {
    ...
    const deleteRow = async () => {
        try {
            ...
            console.log({ error });
            props.alert({ title: "Permission Fields", type: "error", message: error.message || "Failed delete record" });
        }
    };
            ...
            <div className="grid">
                <div className="col-6 flex align-items-center justify-content-start">
                    <h4 className="mb-0 ml-2">
                        <span> My App /{" "}</span>
                        <strong>Permission Fields </strong>
                    </h4>
                    <SplitButton
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="permissionFields-add-button"/>
            ...
            <div className="grid align-items-center">
                <div className="col-12" role="permissionFields-datatable">
                    <PermissionFieldsDatatable items={data} fields={fields} onRowDelete={onRowDelete} onEditRow={onEditRow} onRowClick={onRowClick} searchDialog={searchDialog} setSearchDialog={setSearchDialog}
...
/>            
      ...
      />
            ...
            <PermissionFieldsCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
