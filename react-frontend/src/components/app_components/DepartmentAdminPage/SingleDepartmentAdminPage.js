...
const [employeeId, setEmployeeId] = useState([]);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleDepartmentAdminId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
            ...
            ? res.departmentId.map((elem) => ({ _id: elem._id, deptName: elem.deptName }))
            : res.departmentId
                ? [{ _id: res.departmentId._id, deptName: res.departmentId.deptName }]
                : [];
...
const employeeId = Array.isArray(res.employeeId)
        ...
        setEmployeeId(employeeId);
            ...
            .catch((error) => {
                console.log({ error });
                props.alert({ title: "DepartmentAdmin", type: "error", message: error.message || "Failed get departmentAdmin" });
            });
    }, [props,urlParams.singleDepartmentAdminId]);


    const goBack = () => {
        navigate("/app/departmentAdmin");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Department Admin</h3>
                    <SplitButton
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">EmployeeId</label>
                    {employeeId.map((elem) => (
