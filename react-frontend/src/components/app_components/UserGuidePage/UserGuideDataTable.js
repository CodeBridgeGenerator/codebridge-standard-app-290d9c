...
const p_dateTemplate1 = (rowData, { rowIndex }) => <p >{moment(rowData.expiry).fromNow()}</p>
...
<Column field="expiry" header="Expiry" body={p_dateTemplate1} filter={selectedFilterFields.includes("expiry")} hidden={selectedHideFields?.includes("expiry")}  sortable style={{ minWidth: "8rem" }} />
