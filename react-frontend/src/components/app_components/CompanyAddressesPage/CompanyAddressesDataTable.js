...
const CompanyAddressesDataTable = ({ items, fields, onEditRow, onRowDelete, onRowClick, searchDialog, setSearchDialog,   showUpload, setShowUpload,
...
<Column field="street1" header="Street 1" body={inputTextareaTemplate1} filter={selectedFilterFields.includes("street1")} hidden={selectedHideFields?.includes("street1")}  sortable style={{ minWidth: "8rem" }} />
<Column field="street2" header="Street 2" body={inputTextareaTemplate2} filter={selectedFilterFields.includes("street2")} hidden={selectedHideFields?.includes("street2")}  sortable style={{ minWidth: "8rem" }} />
