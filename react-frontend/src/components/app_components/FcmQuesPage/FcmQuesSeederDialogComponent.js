...
import seederData from "./fcmQues.seeder.json";
...
const FcmQuesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(FcmQuesSeederDialogComponent);
