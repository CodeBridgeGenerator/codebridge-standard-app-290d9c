...
import seederData from "./errorLogs.seeder.json";
...
const ErrorLogsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ErrorLogsSeederDialogComponent);
