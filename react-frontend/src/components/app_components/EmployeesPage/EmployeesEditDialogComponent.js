...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="dateJoined" value={_entity?.dateJoined ? new Date(_entity?.dateJoined) : null} onChange={ (e) => setValByKey("dateJoined", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="dateTerminated" value={_entity?.dateTerminated ? new Date(_entity?.dateTerminated) : null} onChange={ (e) => setValByKey("dateTerminated", new Date(e.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
