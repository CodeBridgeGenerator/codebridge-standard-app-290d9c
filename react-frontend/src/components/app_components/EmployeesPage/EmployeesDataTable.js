...
const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.company}</p>
const pTemplate4 = (rowData, { rowIndex }) => <p >{rowData.department}</p>
const pTemplate5 = (rowData, { rowIndex }) => <p >{rowData.section}</p>
const pTemplate6 = (rowData, { rowIndex }) => <p >{rowData.position}</p>
const pTemplate7 = (rowData, { rowIndex }) => <p >{rowData.supervisor}</p>
const pTemplate8 = (rowData, { rowIndex }) => <p >{rowData.dateJoined}</p>
const pTemplate9 = (rowData, { rowIndex }) => <p >{rowData.dateTerminated}</p>
...
<Column field="fullName" header="Full Name" body={pTemplate2} filter={selectedFilterFields.includes("fullName")} hidden={selectedHideFields?.includes("fullName")}  sortable style={{ minWidth: "8rem" }} />
<Column field="company" header="Company" body={pTemplate3} filter={selectedFilterFields.includes("company")} hidden={selectedHideFields?.includes("company")}  sortable style={{ minWidth: "8rem" }} />
<Column field="department" header="Department" body={pTemplate4} filter={selectedFilterFields.includes("department")} hidden={selectedHideFields?.includes("department")}  sortable style={{ minWidth: "8rem" }} />
<Column field="section" header="Section" body={pTemplate5} filter={selectedFilterFields.includes("section")} hidden={selectedHideFields?.includes("section")}  sortable style={{ minWidth: "8rem" }} />
<Column field="position" header="Position" body={pTemplate6} filter={selectedFilterFields.includes("position")} hidden={selectedHideFields?.includes("position")}  sortable style={{ minWidth: "8rem" }} />
<Column field="supervisor" header="Supervisor" body={pTemplate7} filter={selectedFilterFields.includes("supervisor")} hidden={selectedHideFields?.includes("supervisor")}  sortable style={{ minWidth: "8rem" }} />
<Column field="dateJoined" header="Date Joined" body={pTemplate8} filter={selectedFilterFields.includes("dateJoined")} hidden={selectedHideFields?.includes("dateJoined")}  sortable style={{ minWidth: "8rem" }} />
<Column field="dateTerminated" header="Date Terminated" body={pTemplate9} filter={selectedFilterFields.includes("dateTerminated")} hidden={selectedHideFields?.includes("dateTerminated")}  sortable style={{ minWidth: "8rem" }} />
