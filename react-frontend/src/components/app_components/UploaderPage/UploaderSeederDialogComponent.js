...
import seederData from "./uploader.seeder.json";
...
const UploaderSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(UploaderSeederDialogComponent);
