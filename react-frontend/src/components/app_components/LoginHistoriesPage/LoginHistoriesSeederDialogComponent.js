...
import seederData from "./loginHistories.seeder.json";
...
const LoginHistoriesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(LoginHistoriesSeederDialogComponent);
