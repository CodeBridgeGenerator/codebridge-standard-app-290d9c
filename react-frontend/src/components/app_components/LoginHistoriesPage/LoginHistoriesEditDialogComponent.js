...
const LoginHistoriesEditDialogComponent = (props) => {
...
browser: _entity?.browser,
userAgent: _entity?.userAgent,
loginTime: _entity?.loginTime,
        };

        setLoading(true);
        try {
            
        await client.service("loginHistories").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info loginHistories updated successfully" });
    ...
    return (
        <Dialog header="Edit Login Histories" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="loginHistories-edit-dialog-component">
...
export default connect(mapState, mapDispatch)(LoginHistoriesEditDialogComponent);
