...
import seederData from "./chataiEnabler.seeder.json";
...
const ChataiEnablerSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ChataiEnablerSeederDialogComponent);
