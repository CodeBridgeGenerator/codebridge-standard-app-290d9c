...
import ChataiConfigPage from "../ChataiConfigPage/ChataiConfigPage";
import ChataiPromptsPage from "../ChataiPromptsPage/ChataiPromptsPage";

const SingleChataiEnablerPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleChataiEnablerId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleChataiEnablerId]);


    const goBack = () => {
        navigate("/app/chataiEnabler");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">Chat Ai Enabler</h3>
                    <SplitButton
                ...
                {/* <p>chataiEnabler/{urlParams.singleChataiEnablerId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Description</label><p className="m-0 ml-3"  dangerouslySetInnerHTML={{__html: _entity?.description}}></p></div>
    ...
    <div className="col-12 mt-2">
        <TabView>
                    ...
                    <TabPanel header="Chatai Config" leftIcon="pi pi-building-columns mr-2">
                        <ChataiConfigPage/>
                    </TabPanel>
      ...
      <CommentsSection
        recordId={urlParams.singleChataiEnablerId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleChataiEnablerPage);
