                ...
                },
{
                  ...
                  menuKey: "userAddresses",
                  to: "/app/userAddresses",
                },
{
                  icon: <Home />,
                  label: "Company Addresses",
                  menuKey: "companyAddresses",
                  to: "/app/companyAddresses",
                },
{
                  icon: <Home />,
                  label: "Company Phones",
                  menuKey: "companyPhones",
                  to: "/app/companyPhones",
                },
{
                  icon: <Home />,
                  label: "User Phones",
                ...
                },
{
                  ...
                  menuKey: "departmentAdmin",
                  to: "/app/departmentAdmin",
                },
{
                  icon: <Home />,
                  label: "Department HOD",
                  menuKey: "departmentHOD",
                  to: "/app/departmentHOD",
                },
{
                  icon: <Home />,
                  label: "Department HOS",
                  menuKey: "departmentHOS",
                  to: "/app/departmentHOS",
                },
{
                  icon: <Home />,
                  label: "User Guide Steps",
                  menuKey: "userGuideSteps",
                  to: "/app/userGuideSteps",
                },
{
                  icon: <Home />,
                  label: "User Guides",
...
{
                  icon: <Home />,
                  label: "Chat Ai Enabler",
                  menuKey: "chataiEnabler",
                  to: "/app/chataiEnabler",
                },
{
                  icon: <Home />,
                  label: "Chat Ai Config",
                  menuKey: "chataiConfig",
                  to: "/app/chataiConfig",
                },
{
                  icon: <Home />,
                  label: "Chat Ai Prompts",
                  menuKey: "chataiPrompts",
                  to: "/app/chataiPrompts",
                },
{
                  icon: <Home />,
                  label: "Document Storages",
...
{
                  icon: <Home />,
                  label: "Help Sidebar Contents",
                  menuKey: "helpSidebarContents",
                  to: "/app/helpSidebarContents",
                },
{
                  icon: <Home />,
                  label: "Login Histories",
                  menuKey: "loginHistories",
                  to: "/app/loginHistories",
                },
{
                  icon: <Home />,
                  label: "Mail Ques",
                ...
                },
{
                  ...
                  menuKey: "userChangePassword",
                  to: "/app/userChangePassword",
                },
{
                  icon: <Home />,
                  label: "User Invites",
                ...
                },
{
                  icon: <Home />,
                  label: "User Tracker",
                  menuKey: "userTrackerId",
                  to: "/app/userTrackerId",
                },
{
                  icon: <Home />,
                  label: "Permission Services",
                  menuKey: "permissionServices",
                  to: "/app/permissionServices",
                },
{
                  icon: <Home />,
                  label: "Permission Fields",
                  menuKey: "permissionFields",
                  to: "/app/permissionFields",
                },
{
                  icon: <Home />,
                  label: "ErrorLogs",
